...
function GameOpration:deal65Chi(pBuffer)
    ...
    if(cbCardList[49]~= 0 and cbCardList[50]~= 0 and cbCardList[51]~= 0 )and (cbOperateCard == 49 or cbOperateCard == 50 or cbOperateCard == 51 or cbOperateCard == 70) then 
        local ChiCard = {}
        ChiCard[1] = 49 
        ChiCard[2] = 50 
        ChiCard[3] = 51 
    ...
    if(cbCardList[49]~= 0 and cbCardList[50]~= 0 and cbCardList[52]~= 0 )and (cbOperateCard == 49 or cbOperateCard == 50 or cbOperateCard == 52 or cbOperateCard == 70) then 
        local ChiCard = {}
        ChiCard[1] = 49 
        ChiCard[2] = 50 
        ChiCard[3] = 52 
    ...
    if(cbCardList[50]~= 0 and cbCardList[51]~= 0 and cbCardList[52]~= 0 )and (cbOperateCard == 50 or cbOperateCard == 51 or cbOperateCard == 52 or cbOperateCard == 70) then 
        local ChiCard = {}
        ChiCard[1] = 50 
        ChiCard[2] = 51 
        ChiCard[3] = 52 
