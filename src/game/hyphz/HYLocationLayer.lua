...
local HYLocationLayer          = class("HYLocationLayer", cc.load("mvc").ViewBase)

function HYLocationLayer:onConfig()
    self.widget             = {
        {"Panel_root", "onClose"},
        {"Image_distance2"},
        {"Image_distance3"},
...
--                            game logic                              --
------------------------------------------------------------------------
function HYLocationLayer:refreshUI()
...
function HYLocationLayer:showPlayerPosition(rootNode, playerNum)
...
function HYLocationLayer:RET_GAMES_USER_POSITION(event)
    local playerNum = GameCommon.gameConfig.bPlayerCount
    local rootNode = self['Image_distance' .. playerNum]
    rootNode:setVisible(true)
    self:showPlayerPosition(rootNode, playerNum)
