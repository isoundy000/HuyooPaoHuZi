...
function GameCommon:init()
	    --数据
    self.regionSound = 0
    self.language = cc.UserDefault:getInstance():getIntegerForKey('ZZvolumeSelect', 0)  	--语言 0-普通话 1-方言
...
function GameCommon:getViewIDByChairID(wChairID, isNoSwitch)
    ...
    --两人玩法调整头像位置
    if not isNoSwitch then
        if wPlayerCount == 2 and viewID == 2 then    
            viewID = 3
        elseif wPlayerCount == 3 and viewID == 3 then    
            viewID = 4
        end
    end
...
function GameCommon:GetCardHand(data)
    ...
    if CHANNEL_ID == 9 or CHANNEL_ID == 8 then 
        cardIndex = 0--cc.UserDefault:getInstance():getIntegerForKey(Default.UserDefault_ZiPaiCard,1)
    else
        cardIndex = 0--cc.UserDefault:getInstance():getIntegerForKey(Default.UserDefault_ZiPaiCard,0)
    end
    local cardBgIndex =nil
    if CHANNEL_ID == 10 or CHANNEL_ID == 11 or CHANNEL_ID == 2 or CHANNEL_ID == 3 then 
        cardBgIndex = 1--cc.UserDefault:getInstance():getIntegerForKey(Default.UserDefault_ZiPaiCardBg,1)
    else
        cardBgIndex = 1--cc.UserDefault:getInstance():getIntegerForKey(Default.UserDefault_ZiPaiCardBg,0)
    end
    if data == 0 then
        -- if cardBgIndex ~= 0 then
            imgCard = ccui.ImageView:create("zhuzhou/card_bg/card_bg0/card_bg_1.png")
        -- else
        --  imgCard = ccui.ImageView:create("zhuzhou/card_bg/card_bg1/card_bg_1.png")
        -- end
    elseif data==33 then
        if cardIndex == 0 then
            imgCard = ccui.ImageView:create("zhuzhou/card/card0/dww.png")
        elseif cardIndex == 1 then
            imgCard = ccui.ImageView:create("zhuzhou/card/card1/dww.png")
        elseif cardIndex == 2 then
            imgCard = ccui.ImageView:create("zhuzhou/card/card2/dww.png")
        elseif cardIndex == 3 then
            imgCard = ccui.ImageView:create("zhuzhou/card/card3/dww.png")
        end
    elseif data <= 10 then
        if cardIndex == 0 then
            imgCard = ccui.ImageView:create(string.format("zhuzhou/card/card0/x%d.png",data))
        elseif cardIndex == 1 then
            imgCard = ccui.ImageView:create(string.format("zhuzhou/card/card1/x%d.png",data))
        elseif cardIndex == 2 then
            imgCard = ccui.ImageView:create(string.format("zhuzhou/card/card2/x%d.png",data))
        elseif cardIndex == 3 then
            imgCard = ccui.ImageView:create(string.format("zhuzhou/card/card3/x%d.png",data))
        end
    elseif data > 10 then
        if cardIndex == 0 then
            imgCard = ccui.ImageView:create(string.format("zhuzhou/card/card0/d%d.png",data-16))
        elseif cardIndex == 1 then
            imgCard = ccui.ImageView:create(string.format("zhuzhou/card/card1/d%d.png",data-16))
        elseif cardIndex == 2 then
            imgCard = ccui.ImageView:create(string.format("zhuzhou/card/card2/d%d.png",data-16))
        elseif cardIndex == 3 then
            imgCard = ccui.ImageView:create(string.format("zhuzhou/card/card3/d%d.png",data-16))
        end
    else
        assert(false)
    end
...
function GameCommon:getSendOrOutCard(data, isSendCard)
    ...
    if isSendCard == true then
        imgBg = ccui.ImageView:create("zhuzhou/table/card_send_card_bj.png")    
    else
        imgBg = ccui.ImageView:create("zhuzhou/table/card_out_card_bj.png")
    end
    local imgCard = nil
    if data == 0 then
        -- if cardBgIndex ~= 0 then
        --   imgCard = ccui.ImageView:create("zhuzhou/card_bg/card_bg1/card_bg_3.png")
        -- else
             imgCard = ccui.ImageView:create("zhuzhou/card_bg/card_bg0/card_bg_3.png")
        -- end
    elseif data==33 then
        if cardIndex == 0 then
            imgCard = ccui.ImageView:create("zhuzhou/card/card0/ww.png")
        elseif cardIndex == 1 then
            imgCard = ccui.ImageView:create("zhuzhou/card/card1/ww.png")
        elseif cardIndex == 2 then
            imgCard = ccui.ImageView:create("zhuzhou/card/card2/ww.png")
        elseif cardIndex == 3 then
            imgCard = ccui.ImageView:create("zhuzhou/card/card3/ww.png")
        end
    elseif data <= 10 then
        if cardIndex == 0 then
            imgCard = ccui.ImageView:create(string.format("zhuzhou/card/card0/dx%d.png",data))
        elseif cardIndex == 1 then
            imgCard = ccui.ImageView:create(string.format("zhuzhou/card/card1/dx%d.png",data))
        elseif cardIndex == 2 then
            imgCard = ccui.ImageView:create(string.format("zhuzhou/card/card2/dx%d.png",data))
        elseif cardIndex == 3 then
            imgCard = ccui.ImageView:create(string.format("zhuzhou/card/card3/dx%d.png",data))
        end
    elseif data > 10 then
        if cardIndex == 0 then
            imgCard = ccui.ImageView:create(string.format("zhuzhou/card/card0/dd%d.png",data-16))
        elseif cardIndex == 1 then
            imgCard = ccui.ImageView:create(string.format("zhuzhou/card/card1/dd%d.png",data-16))
        elseif cardIndex == 2 then
            imgCard = ccui.ImageView:create(string.format("zhuzhou/card/card2/dd%d.png",data-16))
        elseif cardIndex == 3 then
            imgCard = ccui.ImageView:create(string.format("zhuzhou/card/card3/dd%d.png",data-16))
        end
    else
        assert(false)
    end    
    if isSendCard == nil then
        return imgCard
    end 
...
function GameCommon:getDiscardCardAndWeaveItemArray(data)
    ...
    local cardBgIndex =nil
    if CHANNEL_ID == 10 or CHANNEL_ID == 11 or CHANNEL_ID == 2 or CHANNEL_ID == 3  then 
        cardBgIndex = 0--cc.UserDefault:getInstance():getIntegerForKey(Default.UserDefault_ZiPaiCardBg,1)
    else
        cardBgIndex = 0--cc.UserDefault:getInstance():getIntegerForKey(Default.UserDefault_ZiPaiCardBg,0)
    end
    local imgCard = nil
    if data == 0 then
        -- if cardBgIndex ~= 0 then
        --     imgCard = ccui.ImageView:create("zhuzhou/card_bg/card_bg1/card_bg_2.png")
        -- else
            imgCard = ccui.ImageView:create("zhuzhou/card_bg/card_bg0/card_bg_2.png")
        -- end
    elseif data==33 then
        if cardIndex == 0 then
            imgCard = ccui.ImageView:create("zhuzhou/card/card0/xw.png")
        elseif cardIndex == 1 then
            imgCard = ccui.ImageView:create("zhuzhou/card/card1/xw.png")
        elseif cardIndex == 2 then
            imgCard = ccui.ImageView:create("zhuzhou/card/card2/xw.png")
        elseif cardIndex == 3 then
            imgCard = ccui.ImageView:create("zhuzhou/card/card3/xw.png")
        end

    elseif data <= 10 then
        if cardIndex == 0 then
            imgCard = ccui.ImageView:create(string.format("zhuzhou/card/card0/ss%d.png",data))
        elseif cardIndex == 1 then
            imgCard = ccui.ImageView:create(string.format("zhuzhou/card/card1/ss%d.png",data))
        elseif cardIndex == 2 then
            imgCard = ccui.ImageView:create(string.format("zhuzhou/card/card2/ss%d.png",data))
        elseif cardIndex == 3 then
            imgCard = ccui.ImageView:create(string.format("zhuzhou/card/card3/ss%d.png",data))
        end
    elseif data > 10 then
        if cardIndex == 0 then
            imgCard = ccui.ImageView:create(string.format("zhuzhou/card/card0/s%d.png",data-16))
        elseif cardIndex == 1 then
            imgCard = ccui.ImageView:create(string.format("zhuzhou/card/card1/s%d.png",data-16))
        elseif cardIndex == 2 then
            imgCard = ccui.ImageView:create(string.format("zhuzhou/card/card2/s%d.png",data-16))
        elseif cardIndex == 3 then
            imgCard = ccui.ImageView:create(string.format("zhuzhou/card/card3/s%d.png",data-16))
        end
    else
        assert(false)
    end
...
function GameCommon:playAnimation(root, id, wChairID)
    ...
    if AnimationData.animFile ~= "" then
        print("++++++AnimationData.animFile+++++++++",AnimationData.animFile)
