...
local GameCommon = {
    ...
    outOprationState = false,                      -- 托管  默认为否
...
function GameCommon:GetCardHand(data)
    local imgCard = nil    
    if data == 0 then           
        imgCard = ccui.ImageView:create("yongzhou/card/HandBG.png")

    elseif data==33 then
        imgCard = ccui.ImageView:create("yongzhou/card/Handww.png")
    elseif data <= 10 then
        imgCard = ccui.ImageView:create(string.format("yongzhou/card/x%d.png",data))
    elseif data > 10 then
        imgCard = ccui.ImageView:create(string.format("yongzhou/card/d%d.png",data-16))
    else
        assert(false)
    end
    return imgCard
...
function GameCommon:getSendOrOutCard(data, isSendCard)
    ...
    if isSendCard == true then
        imgBg = ccui.ImageView:create("yongzhou/card/mopai_bj.png")    
    else
        imgBg = ccui.ImageView:create("yongzhou/card/chupai_bj.png")
    end
    local imgCard = nil
    if data == 0 then
        imgCard = ccui.ImageView:create("yongzhou/card/normalBG.png")
    elseif data==33 then
        imgCard = ccui.ImageView:create("yongzhou/card/normalww.png")
    elseif data <= 10 then
        imgCard = ccui.ImageView:create(string.format("yongzhou/card/dx%d.png",data))
    elseif data > 10 then
        imgCard = ccui.ImageView:create(string.format("yongzhou/card/dd%d.png",data-16))
    else
        assert(false)
    end
...
function GameCommon:getDiscardCardAndWeaveItemArray(data)
    ...
    local imgCard = nil
    if data == 0 then
        imgCard = ccui.ImageView:create("yongzhou/card/huxiBG.png")
    elseif data==33 then
        imgCard = ccui.ImageView:create("yongzhou/card/huxiww.png")
    elseif data <= 10 then
        imgCard = ccui.ImageView:create(string.format("yongzhou/card/ss%d.png",data))
    elseif data > 10 then
        imgCard = ccui.ImageView:create(string.format("yongzhou/card/s%d.png",data-16))
    else
        assert(false)
    end
    imgCard.data = data
